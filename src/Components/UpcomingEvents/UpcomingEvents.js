...
const UpcomingEvents = () => {
  ...
  const modalContent = (
    <div>
      <img src={card2} alt="Card" style={{ width: "100%" }} />
      <div className="cardContent">
        ...
        <div className="cardText">
          <p>
            Lorem ipsum dolor sit amet consectetur. Odio risus turpis diam.Lorem
            ipsum dolor sit amet consectetur. Odio risus turpis diam.Lorem ipsum
            dolor sit amet consectetur. Odio risus turpis diam.Lorem ipsum dolor
            sit amet consectetur. Odio risus turpis diam.Lorem ipsum dolor sit
            amet consectetur. Odio risus turpis diam.Lorem ipsum dolor sit amet
            consectetur.
          </p>
        </div>
      </div>
            ...
            <div className="card card1" data-aos="fade-up" data-aos-delay="600">
              ...
              <div className="cardContent">
                <div className="cardSubtitle">
                  15/04/224 | 2:00pm IST | Online
                </div>
                <div className="cardHeading">
                  Better business with Veena Paralikar
                </div>
                <svg
                ...
                <div className="cardText">
                  <p>
                    Lorem ipsum dolor sit amet consectetur. Odio risus turpis
                    diam...
                  </p>
                </div>
                <Link href="#" className="learnMore" onClick={handleOpenModal}>
                  Learn more
                </Link>
              </div>
            </div>
